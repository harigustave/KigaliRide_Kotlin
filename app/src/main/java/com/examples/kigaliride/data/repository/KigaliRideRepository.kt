package com.examples.kigaliride.data.repository

import com.examples.kigaliride.data.model.CustomerInfo
import com.examples.kigaliride.data.model.DriverInfo
import com.examples.kigaliride.data.network.ClosestDriversRequest
//import com.examples.kigaliride.data.network.CustomerLocationRequest
import com.examples.kigaliride.data.network.CustomerLoginRequest
import com.examples.kigaliride.data.network.DriverLocationRequest
import com.examples.kigaliride.data.network.DriverLoginRequest
import com.examples.kigaliride.data.network.RetrofitClient
import com.examples.kigaliride.data.network.SetAvailabilityRequest
import retrofit2.Response
import com.examples.kigaliride.data.network.PasscodeRequest
